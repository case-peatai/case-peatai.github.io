...
name: "Alan Luo"              # REQUIRED: Your name as it should appear
slug: "alan-luo"              # REQUIRED: Your name in lowercase with hyphens (e.g., "jane-doe")
...
email: "alanluo@case.edu"
personal_site: ""                                                                 # URL to your personal site/portfolio or university directory
twitter: ""                                                                       # Full URL
linkedin: "https://www.linkedin.com/in/alanyluo"                                  # Full URL
google_scholar: "https://scholar.google.com/citations?user=CQBC3WgAAAAJ&hl=en"    # Full URL
...
intro: |
  Alan Luo is a PhD student researching ways to build better agents.
bio: |
  Alan Luo is a PhD student researching ways to build better agents through the lens of reasoning, architecture, defence, and human-AI interaction. Through this focus on agents, he hopes to create technology that can improve and optimise the lives of people around the world. Alan did his undergraduate work in computational biology at Carnegie Mellon University with honours before arriving at Case Western Reserve University for his PhD studies.

# --- RESEARCH & PUBLICATIONS ---
# 'research_summary' appears at the top of the Research tab.
research_summary: "Alan's research focus is agents, spanning reasoning, architecture, defence, and human-AI interaction."
