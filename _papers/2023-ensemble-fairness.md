...
authors:
  ...
  - name: "Hridesh Rajan"
journal: ""
conference: "45th International Conference on Software Engineering (ICSE)"

# --- LINKS ---
doi: "10.1109/ICSE48619.2023.00133"
github: "UsmanGohar/FairEnsemble"
arxiv: "2212.04593"
paper_page: ""
...
# --- CONTENT ---
abstract: |
  Machine Learning (ML) software has been widely adopted in modern society, with
  reported fairness implications for minority groups based on race, sex, age,
  etc. Many recent works have proposed methods to measure and mitigate
  algorithmic bias in ML models. The existing approaches focus on single
  classifier-based ML models. However, real-world ML models are often composed
  of multiple independent or dependent learners in an ensemble (e.g., Random
  ...
  real-world ensembles: bagging, boosting, stacking and voting. We have
  developed a benchmark of 168 ensemble models collected from Kaggle on four
  popular fairness datasets. We use existing fairness metrics to understand the
